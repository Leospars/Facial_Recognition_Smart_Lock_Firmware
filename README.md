...
- The footprint of the ESP32-S3 module is slightly smaller than the actual device in the [schematic file](./jupy_lock_schematic.kicad_sch). A perfboard was used instead to connect the pins with dupont jumper wires. 
...
- Breadboard Assembly
![Breadboard Assembly Image](./images/Breadboard_Assembly.png)

- Enclosed Door Lock
![Enclosed Door Lock Image](./images/Enclosed_Door_Lock.png)

- Proposed 3D Model
![Proposed 3D Model Image](./images/Proposed_3D_Model.png)